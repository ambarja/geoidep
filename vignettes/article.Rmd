...
ucayali_prov <- get_provinces(show_progress = FALSE) |> 
...
ucayali.if <- st_filter(incendio.forestal, ucayali_prov)
head(ucayali.if)
```
...
popup <- paste0(
  "<b>Fecha:<b/> ",ucayali.if$FECREG,"<br>",
  "<b>Hora:<b/> ",ucayali.if$HORA,"<br>",
  "<b>Estado:<b/> ",ucayali.if$ESTADO,"<br>",
  "<b>Lat:<b/> ",ucayali.if$LATITUD,"<br>",
  "<b>Lng:<b/> ",ucayali.if$LONGITUD,"<br>"
)
...
ucayali.if |> 
  ...
  addPolygons(data = ucayali_prov,fill = NA,color = "black",opacity = 1,weight = 0.9) 
```
